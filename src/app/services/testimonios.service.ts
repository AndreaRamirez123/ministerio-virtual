...
export class TestimoniosService {
  private apiUrl = 'http://localhost:3000/api/testimonios'; // o la URL correcta de tu backend

  constructor(private http: HttpClient) {}

  agregarTestimonio(testimonio: any) {
    return this.http.post(this.apiUrl, testimonio); // 👈 Esta línea debe existir
  }
